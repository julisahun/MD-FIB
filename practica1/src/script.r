...
gpus <- separate(data=gpus, col=PSU, into = c("PSU_Watt", "PSU_Amps"), sep=" & ") 
#WATTS
...
#AMPS
sum(is.na(gpus$PSU_Amps)) #1508 nulls
gpus$PSU_Amps <- gsub(' ','',gsub('Amps','', gpus$PSU_Amps))
gpus$PSU_Amps <- as.numeric(gpus$PSU_Amps)
